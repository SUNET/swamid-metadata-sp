...
class Configuration {
  ...
  public function __construct($startDB = true) {
    ...
    $reqParamsFederation = array('displayName', 'longName', 'displayNameQA', 'noAccountHtml', 'name', 'aboutURL', 'contactURL', 'logoURL', 'logoWidth', 'logoHeight', 'languages', 'swamid_assurance');
